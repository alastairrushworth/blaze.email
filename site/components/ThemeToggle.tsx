...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="fixed top-4 left-14 p-2 rounded-full bg-white dark:bg-gray-800 shadow-lg flex items-center transition-colors hover:bg-indigo-50 dark:hover:bg-gray-700"
